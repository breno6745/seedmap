...
const STRUCTURE_META = {
  ...
  monument: { name: "Monumento oceânico", icon: "markers/mc-monument-v4.png" },
  mineshaft: { name: "Mina abandonada", icon: "markers/mc-mineshaft-v3.png" },
  spawn: { name: "Spawn do mundo", icon: "markers/mc-spawn-v4.png" }
};
...
function drawWorldSpawn(ratio) {
  ...
  const image = loadIcon("markers/mc-spawn-v4.png");

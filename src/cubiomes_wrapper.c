                    ...
                    int maximum, int *output)
{
    ...
    /*
     * getMineshafts recebe:
     * chunk inicial X/Z e chunk final X/Z, ambos inclusivos.
     */
    ...
    {
        /*
         * Cubiomes já devolve coordenadas em blocos.
         * +8 coloca o marcador no centro do chunk.
         */

...
- Strongholds removidos da interface e do cálculo.
- Minas abandonadas corrigidas: o código agora passa chunk inicial e final
  corretamente ao `getMineshafts`.
- As posições retornadas pelo Cubiomes já são em blocos e não são mais
  multiplicadas por 16 novamente.
- Marcadores usam texturas PNG do Minecraft Java 1.8.8.
